...
/** Replace 'XYZILoaderIOPlugin' by your own plugin class name throughout and then
	check 'XYZILoaderIOPlugin.cpp' for more directions.
...
//! Example I/O Plugin
class XYZILoaderIOPlugin : public QObject, public ccIOPluginInterface
{
	Q_OBJECT
...
public:
	explicit XYZILoaderIOPlugin( QObject *parent = nullptr );
	~XYZILoaderIOPlugin() override = default;
