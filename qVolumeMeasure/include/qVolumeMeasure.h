...
/** Replace 'qVolumeMeasure' by your own plugin class name throughout and then
	check 'qVolumeMeasure.cpp' for more directions.
...
**/
class qVolumeMeasure : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.cloudcompare.plugin.VolumeMeasure" FILE "../info.json" )

public:
	explicit qVolumeMeasure( QObject *parent = nullptr );
	~qVolumeMeasure() override = default;
